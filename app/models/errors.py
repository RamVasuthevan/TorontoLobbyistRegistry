...
def get_enum_date_must_be_before_or_equal(variable_name:str, variable_value:date, after_variable_name:str, after_variable_value:date):
    return f"{variable_name} {variable_value} must be before or equal to {after_variable_name} {after_variable_value}"

def get_enum_date_must_be_after_or_equal(variable_name:str, variable_value:date, after_variable_name:str, after_variable_value:date):
